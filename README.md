...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/d2xd
```

A live public deployment of this template is available at [https://d2xd.templates.workers.dev](https://d2xd.templates.workers.dev)
